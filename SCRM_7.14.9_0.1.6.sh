...
echo "Installing and configuring SuiteCRM 7.14.9..."
cd /var/www
sudo rm -rf html
sudo mkdir -p html/suitecrm
cd html/suitecrm
...
display_errors = Off
EOF
#11. Directory permissions setup
echo "Setting permissions..."
sudo chown -R www-data:www-data /var/www/html/suitecrm
sudo chmod -R 775 /var/www/html/suitecrm
#12. Special directories creation and permissions
sudo -u www-data mkdir -p /var/www/html/suitecrm/cache/{images,modules,pdf,upload,xml,themes}
sudo -u www-data mkdir -p /var/www/html/suitecrm/custom
sudo -u www-data touch /var/www/html/suitecrm/config.php
sudo -u www-data touch /var/www/html/suitecrm/config_override.php
#13. Create main .htaccess
cat << EOF | sudo tee /var/www/html/suitecrm/.htaccess
...
sudo chmod 644 /var/www/html/suitecrm/.htaccess
...
sudo chmod 775 /var/www/html/suitecrm/config_override.php
...
echo "Access your SuiteCRM installation at: http://$server_ip"
echo ""
...
echo "sudo chmod -R 775 /var/www/html/suitecrm"
echo "sudo chown -R www-data:www-data /var/www/html/suitecrm"
echo ""
echo "Good luck!!!"
